...
You only need to install Atari Machine Edition on the Atari2600 Plus, THEA400 Mini or Atari Gamestsion Pro, they are now standalone install setups exe files so one for each model of machine now.
